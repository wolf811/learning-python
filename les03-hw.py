...
>>>>>>> 1f3ea40aa6af1eadd2e4316113176cf57849d29b
...
# def sumnumber():
#     """Часть решения, которая вычисляет только сумму чисел"""
...
# ============= Задание 6 ===========
# def int_func():
#     text = input('Ввести слово: ')
#     return text.capitalize()
# def str_func(*args):
#     text = input('Ввести слова через пробел: ').title()
#     return f'{text} ' + int_func()
